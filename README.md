...
│
├── workflows/
│   ├── ThreatForge - 01 - Security Alert Collection.json
│   ├── ThreatForge - 02 - Threat Intelligence Enrichment.json
│   ├── ThreatForge - 03 - AI Threat Classification.json
│   ├── ThreatForge - 04 - Incident Assignment & Escalation.json
│   ├── ThreatForge - 05 - Analyst Review & Incident Closure.json
│   └── ThreatForge - 06 - SOC Dashboard & Reporting.json
│
├── docs/
│   ├── architecture.png
│   │
...
Aarav Sahni / aaravsahni0104-wq(github profile name)
